...
po::variables_map ParseOpts(int argCount, char** argVar){
  ...
  desc.add_options()("help,h", "Produce help message")
    ...
    ("gpu_idxs,gi", po::value<std::string>()->default_value("0-1"),"gpu index write as 'start idx'-'end idx'")
    ...
    ("full_proxy_dir, fpd", po::value<std::string>()->default_value("/home/dell/workplace/glet-main/resource/proxy"), "/FULL/PATH/TO/resource/proxy" );
    po::variables_map vm;
...
int main(int argc, char* argv[]) {
  ...
  std::vector<int> AVAIL_SIZES= {20,40,50,60,80,100};// {6, 12, 18, 24, 30, 36, 42, 48, 54, 60, 66, 72, 78, 84, 90, 96, 100}; //
